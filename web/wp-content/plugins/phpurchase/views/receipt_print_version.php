  ...
  <table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td>
		...
		<?php
			$printstuff = freightHelper::getFrOrderFromDB($order->id);
			$printstuffstr = "<br>";
			if(is_null($printstuff)){
				$printstuffstr .= "Can't find the shipping info for this order";
			}else{
				$printstuffstr .= "Carrier: " . $printstuff["Carrier"] . "<br>";
				$printstuffstr .= "Transit: " . $printstuff["Transit"] . "<br>";
				$printstuffstr .= "Pickup Time: " . $printstuff["Pickup"] . "<br>";
				$printstuffstr .= "Total Shipping Price: " . $printstuff["Price"] . "<br>";
				$printstuffstr .= "Shipping Id: " . $printstuff["Sid"] . "<br>";
			}
			echo $printstuffstr; 
		?>
		<?php }else{ ?>

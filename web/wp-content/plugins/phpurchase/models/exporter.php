...
class PHPurchaseExporter {
  ...
  public static function exportOrders($startDate, $endDate) {
    ...
    $items = PHPurchaseCommon::getTableName('order_items');
    ...
    foreach($selectedOrders as $o) {
      ...
      PHPurchaseCommon::log('[' . basename(__FILE__) . ' - line ' . __LINE__ . "] Item query: $sql");
    ...
    PHPurchaseCommon::log('[' . basename(__FILE__) . ' - line ' . __LINE__ . "] Report\n$out");
    return $out;
  }

...
<div class='wrap'>
  <div id="order" style="width: 600px; padding: 10px 10px 10px 10px; border: 1px solid #CCCCCC; background-color: #FFF;">
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;" id="PHPurchaseOrderViewTable">
      <tr>
      ...
      <tr>
        ...
        <td style="text-align: right;"><?php echo CURRENCY_SYMBOL ?><?php echo $item->product_price ?></td>
          ...
          foreach($entries as $entryId) {
            if(class_exists(RGFormsModel)) {
              if(RGFormsModel::get_lead($entryId)) {
                $formId = getGravityFormIdForEntry($entryId);
                echo "<tr><td colspan='5'>" . displayGravityForm($entryId) . "</td></tr>";
      ...
      <tr>
        ...
        <td style="text-align: right;"><?php echo CURRENCY_SYMBOL ?><?php echo $order->subtotal ?></td>
      </tr>
      ...
      <tr>
        ...
        <td style="text-align: right;"><?php echo CURRENCY_SYMBOL ?><?php echo $order->shipping ?></td>
      </tr>
      <?php endif; ?>
      ...
      <?php if($order->tax > 0): ?>
        <tr>
          ...
          <td style="text-align: right;"><?php echo CURRENCY_SYMBOL ?><?php echo $order->tax ?></td>
        </tr>
      <?php endif; ?>
      ...
      <?php if(!empty($order->coupon) && $order->coupon != 'none'): ?>
        ...
        <tr>
          ...
          <td colspan="2" style="text-align: right; background-color: #EEE;"><?php echo CURRENCY_SYMBOL ?><?php echo $order->coupon ?></td>
        </tr>
        <tr>
          <td colspan='4'>&nbsp;</td>
        </tr>
      ...
      <tr>
        ...
        <td style="text-align: right;"><?php echo CURRENCY_SYMBOL ?><?php echo $order->total ?></td>
      </tr>
  ...
  <form class="phorm" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>" method='post'>
    ...
    <select name="status" id='status' style=''>
      <?php
        ...
        $opts = explode(',', $setting->lookupValue('status_options'));
        foreach($opts as $o):
          $o = trim($o);
      ?>
...
<div class="wrap" style='float: left; clear: both;'>
  <p><a href='?page=phpurchase/phpurchase.php'>&lt;&lt;&nbsp;&nbsp;Back To Orders</a></p>
</div>

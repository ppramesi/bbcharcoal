...
class upsShip {
	...
	function buildRequestXML() {
		...
		$ShipmentConfirmRequestXML->push('Shipper');
			$ShipmentConfirmRequestXML->element('Name', 'B&B Charcoal');
			$ShipmentConfirmRequestXML->element('AttentionName', 'Travis');
			$ShipmentConfirmRequestXML->element('ShipperNumber', '0Y032A');

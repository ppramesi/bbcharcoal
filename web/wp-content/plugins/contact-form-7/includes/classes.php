...
class WPCF7_ContactForm {
	...
	function form_html() {
		...
		if ( ! $this->responses_count ) {
			...
			if($wpcf7->result['mail_sent']) {
				$form .= '<!-- Google Code for Contact Us Conversion Page -->
					...
					var google_conversion_label = "qPy5CLmmyQYQx6-n4QM";
					...
					<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1009375175/?value=0&amp;label=qPy5CLmmyQYQx6-n4QM&amp;guid=ON&amp;script=0"/>
					</div>
					</noscript>';
			}
		}
